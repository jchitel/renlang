import * as decl from './declarations/visitors';
import * as expr from './expressions/visitors';
import * as stmt from './statements/visitors';
import * as typs from './types/visitors';
...
export interface SyntaxVisitor<P, R = P> extends
    DeclarationVisitor<P, R>,
    ExpressionVisitor<P, R>,
    StatementVisitor<P, R>,
    TypeVisitor<P, R> {}

export interface DeclarationVisitor<P, R = P> extends
...
export interface ExpressionVisitor<P, R = P> extends
...
export interface StatementVisitor<P, R = P> extends
...
export interface TypeVisitor<P, R = P> extends
