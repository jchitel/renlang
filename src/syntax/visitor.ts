...
export type SyntaxVisitor<P, R = P>
    = DeclarationVisitor<P, R>
    & ExpressionVisitor<P, R>
    & StatementVisitor<P, R>
    & TypeVisitor<P, R>;

export type DeclarationVisitor<P, R = P>
...
export type ExpressionVisitor<P, R = P>
...
export type StatementVisitor<P, R = P>
