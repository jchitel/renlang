...
use super::{token::{TokenType, Token}, parser_new::ParseState};

pub fn read_token(state: &mut ParseState) -> Token {
...
/// Prefix operators may come before expressions to form UnaryExpressions
const PREFIX_OPERS: [&str; 4] = [
    "+", // Unary plus, has no effect on numbers but is present for completeness
    "-", // Unary minus, flips the sign of a number
    "!", // Logical not, inverts a boolean value
    "~", // Bitwise not, inverts each bit of a number
];

/// Postfix operators may come after expressions to form UnaryExpressions
const POSTFIX_OPERS: [&str; 2] = [
    "++", // Increment, adds one to a number
    "--", // Decrement, subtracts one from a number
];

/// Infix operators may combine two expressions to form BinaryExpressions
const INFIX_OPERS: [&str; 35] = [
    ...
    "%",    // Modulo (remainder) operator, yields the remainder of division between two integers
    "**",   // Exponentiaion operator, raises one number to the power of another number
    "==",   // Equality operator, returns whether two values can be considered equal
    "!=",   // Inequality operator, returns whether two values cannot be considered equal
    "<",    // Less-than operator, returns whether one value is less than another
    ">",    // Greater-than operator, returns whether one value is greater than another
    "<=",   // Less-than-or-equal-to operator, returns whether one value is less than or equal to another
    ">=",   // Greater-than-or-equal-to operator, returns whether one value is greater than or equal to another
    "&&",   // Logical AND operator, returns whether two boolean values are both true
    "||",   // Logical OR operator, returns whether either one of two boolean values is true
    "&",    // Bitwise AND operator, performs an AND operation on each pair of bits from two numbers
    "|",    // Bitwise OR operator, performs an OR operation on each pair of bits from two numbers
    "^",    // Bitwise XOR operator, performs an XOR operation on each pair of bits from two numbers
    "<<",   // Left shift operator, shifts all bits in a number left by a specific number of bits
    ">>",   // Right shift operator, shifts all bits in a number right by a specific number of bits, copying the first bit into the left bits
    ">>>",  // Unsigned right shift operator, shifts all bits in a number right by a number of bits, placing a 0 into the left bits
    "=",    // Assignment operator, sets a variable's value to the result of some expression
    "+=",   // Addition assignment operator, adds a number to a variable
    "-=",   // Subtraction assignment operator, subtracts a number from a variable
    "*=",   // Multiplication assignment operator, multiplies a variable by a number
    "/=",   // Division assignment operator, divides a variable by a number
    "%=",   // Modulo assignment operator, sets a variable to the result of a modulo operation between itself an a number
    "**=",  // Exponentiation assignment operator, raises a variable to the power of a number
    "&&=",  // Logical AND assignment operator, performs an AND operation between a variable and another boolean
    "||=",  // Logical OR assignment operator, performs an OR operation between a variable and another boolean
    "&=",   // Bitwise AND assignment operator, performs a bitwise AND operation between a variable and another number
    "|=",   // Bitwise OR assignment operator, performs a bitwise OR operation between a variable and another number
    "^=",   // Bitwise XOR assignment operator, performs a bitwise XOR operation between a variable and another number
    "<<=",  // Left shift assignment operator, performs a left shift operation between two numbers
    ">>=",  // Right shift assignment operator, performs a right shift operation between two numbers
    ">>>=", // Unsigned right shift assignment operator, performs an unsigned right shift operation between two numbers
];
