import { Declaration, Namespace, ModuleRef, ModuleStatus, NameTargetStatus, NameTarget, RemoteCircularReference, Reference, MissingModule, MissingExport, RemoteName, ResolvedReference, RemoteEmptyReference } from '../namespace';
import { Dependency, ImportedName, ImportedNamespace, ForwardedName, ForwardedNamespace, PureForward, ExportedName, PureForwardGraph, PureForwardReplacement } from './dependencies';
import { CoreObject, Diagnostic, DiagnosticLevel, FileRange } from '~/core';
